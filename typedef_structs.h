...
//enum typedefs
typedef enum{STD_U,STD_X,STD_0,STD_1,STD_Z,STD_W,STD_L,STD_H,STD_DCARE} signal_value;
typedef enum{SIGNAL_NODE_TYPE,OPERATOR_NODE_TYPE} node_type;
typedef enum{UNARY_OPERATOR,BINARY_OPERATOR} operator_type;
typedef enum{STD_OR,STD_AND,STD_XOR,STD_NEG} gate;
typedef enum{EVALUATION_EVENT,DRIVING_EVENT} event_type;
#endif
